...
<head>
    <meta charset="utf-8"/>
    <title>Kazcic CRM </title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="crm_mikos" name="author"/>

    <!-- App favicon -->
    <link rel="shortcut icon" href="/templates/assets/images/logo_kazcic.ico">

    <!-- Daterangepicker css -->
    <link rel="stylesheet" href="/templates/assets/vendor/daterangepicker/daterangepicker.css">

    <!-- Vector Map css -->
    <link rel="stylesheet" href="/templates/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css">
        ...
        <div class="topbar container-fluid">
            <div class="d-flex align-items-center gap-lg-2 gap-1">
                ...
                <div class="logo-topbar">
                    ...
                    <a href="/" class="logo-light">
                                <span class="logo-lg">
                                    <img src="/templates/assets/images/logo_kazcic.png" alt="logo">
                                </span>
                        <span class="logo-sm">
                                    <img src="/templates/assets/images/logo_kazcic.png" alt="small logo">
                                </span>
                    </a>
                    ...
                    <a href="/" class="logo-dark">
                                <span class="logo-lg">
                                    <img src="/templates/assets/images/logo_kazcic.png" alt="dark logo">
                                </span>
                        <span class="logo-sm">
                                    <img src="/templates/assets/images/logo_kazcic.png" alt="small logo">
                                </span>
            ...
            <ul class="topbar-menu d-flex align-items-center gap-3">
                ...
                <li class="d-none d-md-inline-block">
                    <a class="nav-link" href="index.html" data-toggle="fullscreen">
    ...
    <div class="leftside-menu">
        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            ...
            <ul class="side-nav">
                ...
                <li class="side-nav-title">Сервисы</li>
...
<!-- Vendor js -->
<script src="/templates/assets/js/vendor.min.js"></script>

<!-- Daterangepicker js -->
<script src="/templates/assets/vendor/daterangepicker/moment.min.js"></script>
<script src="/templates/assets/vendor/daterangepicker/daterangepicker.js"></script>

<!-- Apex Charts js -->
<script src="/templates/assets/vendor/apexcharts/apexcharts.min.js"></script>

<!-- Vector Map js -->
<script src="/templates/assets/vendor/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
<script src="/templates/assets/vendor/admin-resources/jquery.vectormap/maps/jquery-jvectormap-world-mill-en.js"></script>
